...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
<h1 class="page-header">修改品牌</h1>
<form action="/index.php?m=Admin&amp;c=Brand&amp;a=edit&amp;id=1" method="post" enctype="multipart/form-data">
    <div class="form-group">
        <label for="name">品牌名称</label>
        <input type="text" class="form-control" id="name" name="name" placeholder="品牌名称" value="<?php echo ($result["name"]); ?>" />
    </div>
    <div class="form-group">
        <label for="logo">LOGO</label>
        <input type="file" class="form-control" id="logo" name="logo"  />
        <div>
            <img src="Uploads/Brand/<?php echo ($result["logo"]); ?>" style="width: 100px;height: 50px;" />
        </div>
    </div>
