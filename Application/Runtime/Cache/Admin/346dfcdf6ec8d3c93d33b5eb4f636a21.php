...
<form action="/index.php?m=Admin&amp;c=goods&amp;a=add" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <select name="goods_cat_id" id="goods_cat_id" class="form-control">
            ...
            <?php if(is_array($cat_list)): $i = 0; $__LIST__ = $cat_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><option value="<?php echo ($row["id"]); ?>"><?php echo ($row["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
    </div>
    <div class="form-group">
        <label for="price">当前价格*</label>
        <input type="text" class="form-control" id="price" name="price" placeholder="当前价格" />
    </div>
    <div class="form-group">
        <label for="original_price">原价格*</label>
        <input type="text" class="form-control" id="original_price" name="original_price" placeholder="原价格" />
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <select name="brand_id" id="brand_id" class="form-control">
            <option value="">--请选择--</option>
            <?php if(is_array($brand_list)): $i = 0; $__LIST__ = $brand_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><option value="<?php echo ($row["id"]); ?>"><?php echo ($row["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
    </div>
